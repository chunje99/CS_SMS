...
namespace CS_SMS_LIB
{
    public class CPrinter
    {
        ...
        {
            if(printer == "QRCode") // CHUTE_  16
            {
                PrintChute();
                return;
            }
            else if(printer == "QRCode2") //box 52
            {
                PrintChute2();
                return;
            }
            else if(printer == "QRCodeIndic") //indicator 52
            {
                PrintIndicator();
                return;
            }
            ...
            for (int j = 0; j < 1 ; j++)
            {
                ...
                BXLLApi.Print1DBarcode(25 * dotsPer1mm, 55 * dotsPer1mm, (int)SLCS_BARCODE.CODE128, 2 * multiplier, 3 * multiplier, 50 * multiplier, (int)SLCS_ROTATION.ROTATE_0, (int)SLCS_HRI.HRI_NOT_PRINT, "8809656137342");
                BXLLApi.PrintDeviceFont(40 * dotsPer1mm, 62 * dotsPer1mm, (int)SLCS_DEVICE_FONT.KOR_20X26, multiplier, multiplier, (int)SLCS_ROTATION.ROTATE_0, false, "8809656137342");
        ...
        public void PrintChute2()
        {
            ...
            for (int k = 0; k < 13 ; k++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    for (int i = 0; i < 2; i++)
                    {
                        int chute_num = k*jcnt*icnt + j * icnt + i;
                        BXLLApi.PrintDeviceFont((2 + i * 50) * dotsPer1mm, (2 + j * 40) * dotsPer1mm, (int)SLCS_DEVICE_FONT.KOR_38X38, multiplier, multiplier, (int)SLCS_ROTATION.ROTATE_0, true, chute_num.ToString());
                        BXLLApi.PrintQRCode((17 + i * 50) * dotsPer1mm, (7 + j * 40) * dotsPer1mm, 1, 4, 5, 0, "CHUTE_" + chute_num.ToString()); ;
                    }
                }
                //	Print Command
                BXLLApi.Prints(1, 1);
            ...
            for (int k = 0; k < 13 ; k++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    for (int i = 0; i < 2; i++)
                    {
                        int chute_num = k*jcnt*icnt + j * icnt + i;
                        BXLLApi.PrintDeviceFont((2 + i * 50) * dotsPer1mm, (2 + j * 40) * dotsPer1mm, (int)SLCS_DEVICE_FONT.KOR_38X38, multiplier, multiplier, (int)SLCS_ROTATION.ROTATE_0, true, chute_num.ToString());
                        BXLLApi.PrintQRCode((17 + i * 50) * dotsPer1mm, (7 + j * 40) * dotsPer1mm, 1, 4, 5, 0, "INDIC_" + chute_num.ToString()); ;
                    }
                }
                //	Print Command
                BXLLApi.Prints(1, 1);
